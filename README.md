...
ML-приложение для приоритизации клиентов. CatBoost-модель предсказывает вероятность оформления срочного депозита. Дашборд, графики, калькулятор оптимальной стратегии обзвона и другое.
